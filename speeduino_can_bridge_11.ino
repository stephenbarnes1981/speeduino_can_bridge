...
void stateWritingCanbus() {
  ...
  else if (dataCoolant>=61&&dataCoolant<=74) adjustedCoolant=0x63;
  else if (dataCoolant>=75&&dataCoolant<=90) adjustedCoolant=0x88;
  else if (dataCoolant>=91&&dataCoolant<=99) adjustedCoolant=0x9C;
